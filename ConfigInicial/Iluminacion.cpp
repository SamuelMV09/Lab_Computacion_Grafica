...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.ambient"),0.5f, 0.3f, 0.3f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 0.8f, 0.87f, 0.8f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.specular"), 0.1f, 1.0f, 0.0f);
        ...
        modelLuz2 = glm::translate(modelLuz2, lightPos2 + movelightPos2);
        modelLuz2 = glm::scale(modelLuz2, glm::vec3(0.3f));
        glUniformMatrix4fv(glGetUniformLocation(lampshader.Program, "model"), 1, GL_FALSE, glm::value_ptr(modelLuz2));
        glDrawArrays(GL_TRIANGLES, 0, 36);
