...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Texturizado-Samuel Medina Villa", nullptr, nullptr);
	...
	// Diffuse map
	image = stbi_load("images/texturaDado.jpg", &textureWidth, &textureHeight, &nrChannels, 4);
	glBindTexture(GL_TEXTURE_2D, texture1);
