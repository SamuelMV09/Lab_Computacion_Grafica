...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate( model, 0.5f, glm::vec3( 1.0f, 4.0f, 1.0f ) ); // use to compare orthographic and perspective projection
		...
		model = glm::rotate(model, 40.f, glm::vec3(1.0f, 4.0f, 1.0f)); // use to compare orthographic and perspective projection
